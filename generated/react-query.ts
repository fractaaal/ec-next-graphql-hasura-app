...
export const OrderCategoryItemsDocument = `
  ...
  items(
    ...
    `;
export const useOrderCategoryItemsQuery = <
      TData = OrderCategoryItemsQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables: OrderCategoryItemsQueryVariables,
      options?: UseQueryOptions<OrderCategoryItemsQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<OrderCategoryItemsQuery, TError, TData>(
      ['orderCategoryItems', variables],
      fetcher<OrderCategoryItemsQuery, OrderCategoryItemsQueryVariables>(client, OrderCategoryItemsDocument, variables, headers),
      options
    );
export const OrderPriceItemsDocument = `
  ...
  items(offset: $offset, limit: $limit, order_by: {price: asc}) {
    ...
    `;
export const useOrderPriceItemsQuery = <
      TData = OrderPriceItemsQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables: OrderPriceItemsQueryVariables,
      options?: UseQueryOptions<OrderPriceItemsQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<OrderPriceItemsQuery, TError, TData>(
      ['orderPriceItems', variables],
      fetcher<OrderPriceItemsQuery, OrderPriceItemsQueryVariables>(client, OrderPriceItemsDocument, variables, headers),
      options
    );
export const PagenationAllItemsDocument = `
  ...
  items(offset: $offset, limit: $limit) {
    ...
    `;
export const usePagenationAllItemsQuery = <
      TData = PagenationAllItemsQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables: PagenationAllItemsQueryVariables,
      options?: UseQueryOptions<PagenationAllItemsQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<PagenationAllItemsQuery, TError, TData>(
      ['pagenationAllItems', variables],
      fetcher<PagenationAllItemsQuery, PagenationAllItemsQueryVariables>(client, PagenationAllItemsDocument, variables, headers),
      options
    );
